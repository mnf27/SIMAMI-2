        ...
        <div class="lg:ml-[244px] flex-1 h-screen flex flex-col">
            ...
            <div class="lg:hidden fixed top-0 left-0 right-0 h-14 bg-[#E5ECFF] z-[985]">
                <div class="h-full px-3 flex items-center justify-between">
                    <!-- Logo -->
                    <?php if (isset($component)) { $__componentOriginal6766ad72772e762d0b4fc9be3de70150 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6766ad72772e762d0b4fc9be3de70150 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.application-logo-mobile','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('application-logo-mobile'); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal6766ad72772e762d0b4fc9be3de70150)): ?>
<?php $attributes = $__attributesOriginal6766ad72772e762d0b4fc9be3de70150; ?>
<?php unset($__attributesOriginal6766ad72772e762d0b4fc9be3de70150); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal6766ad72772e762d0b4fc9be3de70150)): ?>
<?php $component = $__componentOriginal6766ad72772e762d0b4fc9be3de70150; ?>
<?php unset($__componentOriginal6766ad72772e762d0b4fc9be3de70150); ?>
<?php endif; ?>
                    <div class="flex items-center gap-1">
                        <!-- Notification -->
                        <div x-data="{ openNotif:false, count: <?php echo e(auth()->user()->unreadNotifications()->count()); ?>, async refreshNotif() { try { const res = await fetch('/notifications/count'); const data = await res.json(); this.count = data.count; } catch (e) { console.error(e); } } }"
                            ...
                            <div x-show="openNotif" @click.away="openNotif = false" x-transition x-cloak
                                ...
                                <div class="max-h-96 overflow-y-auto">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = auth()->user()->fresh()->notifications->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <a href="<?php echo e(route('notification.read', $notif->id)); ?>"
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($header)): ?>
                <header
                    ...
                    <div class="h-full pl-3 flex items-center justify-between">
                        <!-- Left -->
                        <form action="<?php echo e(route('periode.set')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <?php
                                    ...
                                    <div class="text-left">
                                        <p class="text-xs lg:text-sm font-medium text-slate-600">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedPeriode): ?>
                                                ...
                                                <?php echo e(\App\Helpers\SemesterHelper::label($selectedPeriode)); ?>

                                            <?php else: ?>
                                                Semua Periode
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </p>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activePeriode && $selectedPeriode != $activePeriode->kode): ?>
                                            <p class="text-[10px] text-emerald-600 font-medium">
                                                Aktif: <?php echo e($activePeriode->kode); ?>
                                ...
                                <div x-show="open" @click.away="open = false" x-transition
                                    ...
                                    <div class="max-h-80 overflow-y-auto custom-scroll">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $periodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $periode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <button type="submit" name="periode" value="<?php echo e($periode->kode); ?>"
                                                class="w-full flex items-center justify-between px-3 py-3 hover:bg-[#E0E8FF] transition text-left">
                                                <div>
                                                    <p class="lg:text-sm text-xs font-semibold text-slate-700">
                                                        <?php echo e($periode->kode); ?>

                                                    </p>
                                                    <p class="text-xs text-slate-500">
                                                        <?php echo e($periode->label); ?>

                                                    </p>
                                                </div>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedPeriode == $periode->kode): ?>
                                                    <i data-lucide="check" class="w-4 h-4 text-[#1E3A8A]"></i>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </button>
                                ...
                                <button id="userMenuButton" @click="openUser = !openUser"
                                    ...
                                    <div class="hidden lg:block text-left">
                                        ...
                                        <p class="mt-1 text-xs text-blue-100">
                                            <?php echo e(Auth::user()->role->nama); ?>
...
</html><?php /**PATH C:\laragon\www\simami\resources\views/layouts/app.blade.php ENDPATH**/ ?>