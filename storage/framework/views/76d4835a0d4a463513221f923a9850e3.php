...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        <div class="max-w-[1700px] mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-3">
                ...
                <div class="lg:col-span-2 rounded-2xl border border-slate-200 bg-white py-4 px-5 shadow-sm">
                    ...
                    <div class="space-y-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $temuanTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <a href="<?php echo e(route('asesor.audit.show', $temuan->audit)); ?>?temuan=<?php echo e($temuan->id); ?>"
                ...
                <div class="lg:col-span-1 rounded-2xl border border-slate-200 bg-white py-4 px-5 shadow-sm">
                    ...
                    <!-- LIST -->
                    <div class="space-y-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $auditTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $audit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <a href="<?php echo e(route('asesor.audit.show', $audit->id)); ?>"
                                class="group flex items-start justify-between rounded-2xl border border-slate-100 bg-slate-50/50 p-3 transition-all duration-300 hover:-translate-y-1 hover:border-slate-200 hover:bg-white hover:shadow-lg">
                                <div class="flex items-start gap-3">
                                    <!-- ICON -->
                                    <div
    ...
    <script>
        ...
        const trendChart = new Chart(ctxTrend, {
            type: 'line',
            data: {
                labels: <?php echo json_encode($trendData, 15, 512) ?>,
                datasets: [
                    {
                        label: 'OPEN',
                        data: <?php echo json_encode($openTrend, 15, 512) ?>,
                        borderColor: '#EF4444',
                    ...
                    {
                        label: 'CLOSED',
                        data: <?php echo json_encode($closedTrend, 15, 512) ?>,
                        borderColor: '#22C55E',
...
<?php endif; ?><?php /**PATH C:\laragon\www\simami\resources\views/asesor/dashboard.blade.php ENDPATH**/ ?>