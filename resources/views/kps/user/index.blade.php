                ...
                <div class="relative flex flex-col lg:flex-row lg:justify-between gap-2">
                    <div>
                        ...
                        <p class="text-blue-100 max-w-xl text-sm leading-relaxed">
                            Kelola seluruh akun pengguna SIMAMI mulai dari kps, Auditor,
            ...
            <div
                ...
                <div class="flex flex-wrap gap-2">
                    <div class="flex gap-2">
                        <a href="{{ route('kps.users.template') }}"
                        ...
                        <form action="{{ route('kps.users.import') }}" method="POST" enctype="multipart/form-data">
                            @csrf
