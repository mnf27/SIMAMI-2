<x-app-layout>
    ...
    selectedTemplate: null }" class="py-[15px] lg:py-[14px] lg:py-[12px]">
                        ...
                        <div
                            ...
                            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                <div class="flex items-start gap-3">
                                    {{-- Tombol Aktif --}}
                                    <form action="{{ route('kps.templates.activate', $template) }}" method="POST">
                                        @csrf
        ...
        <x-ui.modal open="openUpload" title="Upload Template Instrumen" maxWidth="max-w-md">
            <form action="{{ route('kps.templates.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
        ...
        <x-ui.modal open="openActivate" title="Aktifkan Template" maxWidth="max-w-md">
            <form :action="'/kps/templates/' + selectedTemplate + '/activate'" method="POST">
                @csrf
                <div class="p-4">
                    <div class="flex items-start gap-3">
